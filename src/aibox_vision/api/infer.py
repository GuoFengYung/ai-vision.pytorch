...
from aibox_vision.lib.bbox import BBox
...
def _infer(
    ...
    if task_name == Task.Name.CLASSIFICATION:
        ...
        from aibox_vision.lib.task.classification.preprocessor import Preprocessor
        from aibox_vision.lib.task.classification.inferer import Inferer
    elif task_name == Task.Name.DETECTION:
        from aibox_vision.lib.task.detection.checkpoint import Checkpoint
        from aibox_vision.lib.task.detection.model import Model
        from aibox_vision.lib.task.detection.preprocessor import Preprocessor
        from aibox_vision.lib.task.detection.inferer import Inferer
        ...
        from aibox_vision.lib.task.instance_segmentation.model import Model
        from aibox_vision.lib.task.instance_segmentation.preprocessor import Preprocessor
        from aibox_vision.lib.task.instance_segmentation.inferer import Inferer
    else:
        raise ValueError
