...
def _analyze(task_name: Task.Name, mode: str, path_to_data_dir: str, path_to_checkpoint: str,
    ...
    if task_name == Task.Name.CLASSIFICATION:
        ...
        from aibox_vision.lib.task.classification.analyzer import Analyzer
        ...
        from aibox_vision.lib.task.detection.analyzer import Analyzer
        ...
        from aibox_vision.lib.task.instance_segmentation.analyzer import Analyzer
