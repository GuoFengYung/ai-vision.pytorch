...
from mirle_vision.api.train import _train
from mirle_vision.lib.task.instance_segmentation.algorithm import Algorithm
from mirle_vision.lib.task.instance_segmentation.config import Config
...
class TrainResumeTestCase(TestCase):
    ...
    def test_resume_checkpoint(self):
        origin_argument = self.Argument(
            ...
            algorithm=Algorithm.Name.MASK_RCNN,
            learning_rate=0.001,
            momentum=0.9,
            weight_decay=0.0005,
        ...
        # NOTE: Uncomment this if second algorithm is done
    ...
    def _train(self, argument: Argument) -> str:
        ...
        config_dict = Config.parse_config_dict(
            task_name=Task.Name.INSTANCE_SEGMENTATION.value,
